...
public:
    static inline std::string name = "ParallelBlockBasedQuickSorter";
    ParallelBlockBasedQuickSorter() : _check(false), _block_size(DEFAULT_BLOCK_SIZE) {}
    ...
    static int32_t DEFAULT_BLOCK_SIZE;
